...
def attack(char_name: str, char_class: str) -> str:
    """Return opponent damage depending on character class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return blocked damage depending on character class."""
    if char_class == 'warrior':
        return (f'{char_name} '
...
def special(char_name: str, char_class: str) -> str:
    """Return special skill usage depending on character class."""
    if char_class == 'warrior':
        return (f'{char_name} '
    ...
    return (f'{char_name} не принимал специальное умение')
...
def choice_char_class() -> str:
    """Return character class depending on player choice."""
    approve_choice: str = ''
    char_class: str = ''
